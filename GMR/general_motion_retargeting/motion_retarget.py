...
class GeneralMotionRetargeting:
    ...
    def __init__(
        ...
        self.default_joint_pose = ik_config.get("default_joint_pose", {})
    ...
    def setup_retarget_configuration(self):
        ...
        if self.posture_cost > 0.0:
            ...
            for joint_name, joint_pos in self.default_joint_pose.items():
                joint_id = mj.mj_name2id(self.model, mj.mjtObj.mjOBJ_JOINT, joint_name)
                if joint_id < 0:
                    raise ValueError(f"Unknown joint in default_joint_pose: {joint_name}")
                target_q[self.model.jnt_qposadr[joint_id]] = joint_pos
